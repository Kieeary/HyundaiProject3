...
public class MypageController {
	...
	/*
	 * author : 왕종휘 유저 정보 변경을 위한 비밀번호 확인 페이지
	 */
	@GetMapping("/change/checkpw")
	public String checkPw(@RequestParam(required = false, name = "error") String error,
	...
	/*
	 * author : 왕종휘 유저 정보 변경을 위한 비밀번호 확인 수행
	 */
	@SuppressWarnings("deprecation")
	@PostMapping("/change/checkpw")
	public String checkPwPost(@AuthenticationPrincipal Account account, @RequestParam("password") String password,
	...
	/*
	 * author : 왕종휘 유저 정보 변경 페이지
	 */
	@GetMapping("/change/form")
	public String changeForm(@AuthenticationPrincipal Account account, Model model) {
		UpdateMemberDTO member = new UpdateMemberDTO(memberService.findMemberByEmail(account.getEmail()));
	...
	/*
	 * author : 왕종휘 찜한 상품 목록 페이지
	 */
	@GetMapping("/wish")
	public String myWishList(@AuthenticationPrincipal Account account) {
	...
	public String orderDetailForm(@AuthenticationPrincipal Account account, @PathVariable("oid") String oid,
			Model model) {
	...
	@ResponseBody
	public ResponseEntity<String> cancelOrder(@AuthenticationPrincipal Account user, @PathVariable("oId") String oId) {
		OrderVO order = orderService.getOrderInfo( oId);
		log.info("{}", order);
